...
type
  ...
  private
    ...
    procedure SetCollapsedSize(AValue: integer);
  ...
  published
    ...
    property CollapsedSize: integer read FCollapsedSize write SetCollapsedSize;
...
procedure TMyRollOut.SetCollapsedSize(AValue: integer);
begin
